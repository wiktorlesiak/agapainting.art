...
if(count($_POST)>0) {
    ...
    $sql = "INSERT INTO paintingsrow2 (p_name, image, p_price, description, f_image) VALUES ('" . $_POST["p_name"] . "','" . $_POST["image"] . "','" . $_POST["p_price"] . "','" . $_POST["description"] . "','" . $_POST["f_image"] . "')";
